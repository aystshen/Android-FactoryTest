...
public class WifiListAdapter extends BaseAdapter {
    ...
    private final int mWaitImg[] = {R.mipmap.ic_wait_0, R.mipmap.ic_wait_1, R.mipmap.ic_wait_2, R.mipmap.ic_wait_3,
            R.mipmap.ic_wait_4, R.mipmap.ic_wait_5, R.mipmap.ic_wait_6, R.mipmap.ic_wait_7, R.mipmap.ic_wait_8};
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (list != null) {
            ...
            if (scanResult.capabilities.contains("WEP")
                ...
                imgPwd.setImageResource(R.mipmap.ic_wifi_pwd);
            }
            ...
            if (level == 3) {
                imgSignal.setImageResource(R.mipmap.ic_wifi_3);
            } else if (level == 2) {
                imgSignal.setImageResource(R.mipmap.ic_wifi_2);
            } else if (level == 1) {
                imgSignal.setImageResource(R.mipmap.ic_wifi_1);
            } else {
                imgSignal.setImageResource(R.mipmap.ic_wifi_0);
            }
            ...
            if (mInfo != null && mInfo.getSSID() != null && mState != null) {
                ...
                if (TextUtils.equals(mInfo.getBSSID(), scanResult.BSSID)) {
                    ...
                    if (mState == NetworkInfo.DetailedState.CONNECTED) {
                        imgConnected.setImageResource(R.mipmap.ic_wifi_connected);
